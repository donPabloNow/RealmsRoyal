...
class UI extends Mesh {
    ...
    constructor({
        ...
        var texture = new CanvasTexture(renderer);
    ...
    dispose() {
        var { material, page, texture } = this;
        material.dispose();
        texture.dispose();
    ...
    draw() {
        ...
        buttons.forEach(({
            ...
            var button = isDisabled ? styles.button.disabled : styles.button;
            ctx.save();
            ctx.translate(x, y);
            ctx.beginPath();
    ...
    onPointer({ point, primary }) {
        var { page: { buttons }, pointer, renderer } = this;
    ...
    setPage(page) {
        var { pages } = this;
        var back = this.page ? this.page.id : undefined;
        this.page = {
            id: page,
            back,
            buttons: [],
