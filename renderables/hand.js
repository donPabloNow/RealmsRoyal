...
class Hand extends SkinnedMesh {
    ...
    static setupGeometry() {
        ...
        var pushBox = (dimensions, bone) => {
            ...
            var box = new BoxGeometry(w, h, d, w * 100, h * 100, d * 100);
            box.translate(x, y, z);
        ...
        var { dimensions: { base, phalange } } = Hand;
        // Base of the hand
        pushBox(base, 0);
    ...
    setFingers(state) {
        ...
        fingers.forEach((finger, i) => {
            var timeScale = animationSpeed * ((state & (1 << i)) ? 1 : -1);
